...
const BelfastPage: React.FC = () => {
  ...
  return (
    <>
      <SEOHead
        title="Garden Sheds & Outdoor Saunas Belfast | NMG Outdoor Living"
        description="Premium steel garden sheds, outdoor saunas & grill pods in Belfast. Expert installation across Belfast & Northern Ireland. Free quotes available."
        keywords={[
          'garden sheds Belfast',
          'steel sheds Belfast',
          'outdoor sauna Belfast',
          'garden sauna Belfast',
          'grill pods Belfast',
          'custom sheds Belfast',
          'heavy duty sheds Belfast',
          'galvanized sheds Belfast',
          'outdoor kitchen Belfast',
          'garden office Belfast'
        ]}
        url="/belfast"
      />
      ...
      <main className="min-h-screen">
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              <div className="flex items-center justify-center mb-6">
                ...
                <span className="text-lg font-medium text-[#C5B8AB]">Serving Belfast & Surrounding Areas</span>
              </div>
              
              <h1 className="text-4xl md:text-6xl font-black mb-6 leading-tight">
                Premium Garden Sheds & Outdoor Saunas in <span className="text-[#C5B8AB]">Belfast</span>
              </h1>
              
              <p className="text-xl md:text-2xl text-gray-300 mb-8 leading-relaxed">
                Transform your Belfast garden with our galvanized steel sheds, energy-efficient saunas, and luxury grill pods. 
                Expert installation across Belfast, Lisburn, Newtownabbey, and beyond.
              </p>
            ...
            <div className="max-w-6xl mx-auto">
              ...
              <div className="grid md:grid-cols-3 gap-8">
                <div className="text-center p-6 bg-gray-50 rounded-lg">
                  ...
                  <h3 className="text-xl font-bold mb-3 text-[#222126]">Local Belfast Expertise</h3>
                  <p className="text-gray-600">
                    Based in Maghera, we understand Belfast's unique weather conditions and planning requirements. 
                    Expert installation across all Belfast postcodes.
                  </p>
                </div>
                ...
                <div className="text-center p-6 bg-gray-50 rounded-lg">
                  ...
                  <p className="text-gray-600">
                    ...
                    saving you money and hassle. Built to withstand Belfast's weather.
                  </p>
                </div>
                ...
                <div className="text-center p-6 bg-gray-50 rounded-lg">
                  ...
                  <p className="text-gray-600">
                    Quick turnaround times for Belfast installations. Our saunas heat up in 15-20 minutes 
        ...
        {/* Belfast Service Areas */}
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4">
            <div className="max-w-6xl mx-auto">
              <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 text-[#222126]">
                We Serve All Belfast Areas
              </h2>
              ...
              <div className="text-center mt-8">
                <p className="text-gray-600 mb-4">
                  Don't see your area? We cover all of Belfast and surrounding regions.
                </p>
                <button
                  onClick={scrollToQuote}
        ...
        {/* Belfast-Specific Benefits */}
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4">
            <div className="max-w-6xl mx-auto">
              <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 text-[#222126]">
                Perfect for Belfast's Climate
              </h2>
              
              <div className="grid md:grid-cols-2 gap-12 items-center">
                <div>
                  <h3 className="text-2xl font-bold mb-6 text-[#222126]">Built for Belfast Weather</h3>
                  <ul className="space-y-4">
                    <li className="flex items-start">
                      <CheckCircle className="w-6 h-6 text-green-500 mr-3 mt-1 flex-shrink-0" />
                      <div>
                        <strong>Galvanized Steel Frames:</strong> Resist Belfast's high winds and coastal conditions
                      </div>
                    </li>
                    <li className="flex items-start">
                      <CheckCircle className="w-6 h-6 text-green-500 mr-3 mt-1 flex-shrink-0" />
                    ...
                    <li className="flex items-start">
                      <CheckCircle className="w-6 h-6 text-green-500 mr-3 mt-1 flex-shrink-0" />
                      <div>
                        <strong>Energy Efficient:</strong> Our saunas heat up quickly, saving on Belfast's energy costs
                      </div>
                    </li>
                    <li className="flex items-start">
                      <CheckCircle className="w-6 h-6 text-green-500 mr-3 mt-1 flex-shrink-0" />
                ...
                <div className="bg-gray-50 p-8 rounded-lg">
                  <h4 className="text-xl font-bold mb-4 text-[#222126]">Belfast Installation Process</h4>
                  <ol className="space-y-3">
                    <li className="flex items-center">
                      ...
                      <span>Free site survey in Belfast</span>
                    </li>
                    <li className="flex items-center">
